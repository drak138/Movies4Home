...
export default function MovieInfo({details,id,title,mediaType}){
    ...
    return(
        <section className="infoContainer">
            <img src={`https://image.tmdb.org/t/p/original/${images?.logos.filter(iso=>iso.iso_639_1=="en").length!==0?images?.logos.filter(iso=>iso.iso_639_1=="en")[0].file_path:"No Logo"}`} alt={title} />
