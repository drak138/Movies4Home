export default function Footer(){
    return (
        <div className="footerContianer">
            <ul>
                <h1>With the help of</h1>
                <li>Chat GPT who never let me down when i needed him most.</li>
                <li>Render who made it possible for my friends to experience my work.</li>
